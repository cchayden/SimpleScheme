...
namespace Tests
{
    ...
    public class ClrTest
    {
        ...
        public void IntClrTest()
        {
            ...
            var res = this.Run(@"
              (begin
                ...
                (int-to-int 1))
            ");
            Check((Number)2.0, "static int to int", res);
            ...
            ");
            Check((Number)2.0, "int to int", res);
            ...
            res = this.Run(@"
              (begin
                ...
                (attr-get test-class))
            ");
            Check((Number)5.0, "int set/get", res);
        }
        ...
        public void DoubleClrTest()
        {
            ...
            ");
            Check((Number)10001.0, "short to short", res);
            ...
            res = this.Run(@"
              (begin
                ...
                (byte-to-byte 41))
            ");
            Check((Number)42.0, "byte to byte", res);
        }
        ...
        /// <summary>
        /// Check that the result was the expected.
        /// </summary>
        /// <param name="expected">The excpected result.</param>
        /// <param name="label">The label to print</param>
        /// <param name="res">The actual result.</param>
        ...
        /// <summary>
        /// Check that the result vector was the expected.
        /// </summary>
        ...
        private class ClrTestClass
        {
            ...
            public static TextReader TextReaderToTextReader(TextReader x)  // unused arg
            {
            ...
            /// <returns>Input value</returns>
            public static TextWriter TextWriterToTextWriter(TextWriter x) // unused arg
            {
