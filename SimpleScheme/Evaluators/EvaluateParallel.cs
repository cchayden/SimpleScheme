...
namespace SimpleScheme
{
    ...
    public sealed class EvaluateParallel : Evaluator
    {
        ...
        {
            var step = (EvaluateParallel)s;
            Evaluator ras = step.CheckForAsyncReturn();
            if (ras != null)
            {
                return ras;
            }
        ...
        /// <summary>
        /// Check the return value to see if it is a special async return value.
        ...
        {
            if (AsyncReturnValue.Is(this.ReturnedExpr))
            {
                switch (AsyncReturnValue.As(this.ReturnedExpr).Value)
                {
                    ...
                    case AsyncReturnValue.CatchCode.CaughtSuspended:
